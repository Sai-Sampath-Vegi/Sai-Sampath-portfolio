...
public class SOSGameGraphicsVersion1 extends Frame implements MouseListener {

    GameBoard board;
    Button closeButton, playAgain, sButton, oButton;
    Label gameTitle, scoresTitle, scoreplayerMove1, scoreplayerMove2, currentMove, status;
    int playerOneScore, playerTwoScore, playerMoveCounter;
    Dialog popupMenu;

    SOSGameGraphicsVersion1() {
        setTitle("SOS Game");
        setLayout(null);
        playerOneScore = 0;
        playerTwoScore = 0;
        ...
        gameTitle.setBounds(325, 100, 350, 50);
        add(gameTitle);
        ...
        currentMove = new Label("PLAYER 1 MOVE");
        scoresTitle.setBounds(750, 250, 100, 50);
        scoreplayerMove1.setBounds(675, 300, 250, 50);
        scoreplayerMove2.setBounds(675, 350, 250, 50);
        currentMove.setBounds(700, 550, 200, 100);
        ...
        playAgain.setBounds(700, 425, 200, 50);
        closeButton.setBounds(700, 490, 200, 50);
        add(playAgain);
        add(closeButton);
        add(board);
        ...
        popupMenu = new Dialog(this, "CHOOSE S OR O", true);
        popupMenu.setSize(200, 80);
    ...
    public void mouseClicked(MouseEvent me) {
        if (me.getSource() == closeButton) {
            ...
            if (!isSecuredPoint) {
                playerMoveCounter++;
                currentMove.setText("PLAYER " + String.valueOf((playerMoveCounter % 2 == 0) ? 2 : 1) + " MOVE");
            }
    ...
    void playAgain() {
        ...
        playerTwoScore = 0;
        playerMoveCounter = 1;
        currentMove.setText("PLAYER 1 MOVE");
            ...
            if ((row == 0 && column == 0) || (row == 9 && column == 0) || (row == 0 && column == 9)
                ...
                if (row == 0 || row == 9) {
                    if (column >= 1 && column <= 8) {
                        if (board.board[row][column - 1] == 'S' && board.board[row][column + 1] == 'S') {
                            if (playerMoveCounter % 2 == 1) {
                                board.completedPositionsOfPlayer1[playerOneScore][0] = row;
                                board.completedPositionsOfPlayer1[playerOneScore][1] = column - 1;
                                board.completedPositionsOfPlayer1[playerOneScore][2] = row;
                                board.completedPositionsOfPlayer1[playerOneScore][3] = column + 1;
                                playerOneScore++;
                            } else {
                                board.completedPositionsOfPlayer2[playerTwoScore][0] = row;
                                board.completedPositionsOfPlayer2[playerTwoScore][1] = column - 1;
                                board.completedPositionsOfPlayer2[playerTwoScore][2] = row;
                                board.completedPositionsOfPlayer2[playerTwoScore][3] = column + 1;
                                playerTwoScore++;
                            }
                            flag = true;
                        }
                    ...
                    if (board.board[row - 1][column] == 'S' && board.board[row + 1][column] == 'S') {
                        if (playerMoveCounter % 2 == 1) {
                            board.completedPositionsOfPlayer1[playerOneScore][0] = row - 1;
                            board.completedPositionsOfPlayer1[playerOneScore][1] = column;
                            board.completedPositionsOfPlayer1[playerOneScore][2] = row + 1;
                            board.completedPositionsOfPlayer1[playerOneScore][3] = column;
                            playerOneScore++;
                        } else {
                            board.completedPositionsOfPlayer2[playerTwoScore][0] = row - 1;
                            board.completedPositionsOfPlayer2[playerTwoScore][1] = column;
                            board.completedPositionsOfPlayer2[playerTwoScore][2] = row + 1;
                            board.completedPositionsOfPlayer2[playerTwoScore][3] = column;
                            playerTwoScore++;
                        }
                        flag = true;
                    }
            ...
            if (row == 0 && column == 0) {
                if (row <= 7) {
                    if (board.board[row + 2][column] == 'S' && board.board[row + 1][column] == 'O') {
                        if (playerMoveCounter % 2 == 1) {
                            board.completedPositionsOfPlayer1[playerOneScore][0] = row + 2;
                            board.completedPositionsOfPlayer1[playerOneScore][1] = column;
                            board.completedPositionsOfPlayer1[playerOneScore][2] = row;
                            board.completedPositionsOfPlayer1[playerOneScore][3] = column;
                            playerOneScore++;
                        } else {
                            board.completedPositionsOfPlayer2[playerTwoScore][0] = row + 2;
                            board.completedPositionsOfPlayer2[playerTwoScore][1] = column;
                            board.completedPositionsOfPlayer2[playerTwoScore][2] = row;
                            board.completedPositionsOfPlayer2[playerTwoScore][3] = column;
                            playerTwoScore++;
                ...
                if (column <= 7) {
                    if (board.board[row][column + 2] == 'S' && board.board[row][column + 1] == 'O') {
                        if (playerMoveCounter % 2 == 1) {
                            board.completedPositionsOfPlayer1[playerOneScore][0] = row;
                            board.completedPositionsOfPlayer1[playerOneScore][1] = column + 2;
                            board.completedPositionsOfPlayer1[playerOneScore][2] = row;
                            board.completedPositionsOfPlayer1[playerOneScore][3] = column;
                            playerOneScore++;
                        } else {
                            board.completedPositionsOfPlayer2[playerTwoScore][0] = row;
                            board.completedPositionsOfPlayer2[playerTwoScore][1] = column + 2;
                            board.completedPositionsOfPlayer2[playerTwoScore][2] = row;
                            board.completedPositionsOfPlayer2[playerTwoScore][3] = column;
                            playerTwoScore++;
                        }
    ...
    public static void main(String args[]) {
        new SOSGameGraphicsVersion1();
    }
}

class GameBoard extends Applet {
    public int completedPositionsOfPlayer1[][] = new int[150][4], completedPositionsOfPlayer2[][] = new int[150][4];
    ...
    public void init() {
        ...
        for (int counter = 0; counter < 150; counter++) {
            completedPositionsOfPlayer1[counter][0] = -1;
            completedPositionsOfPlayer2[counter][0] = -1;
        }
    }
    ...
    public void paint(Graphics g) {
        ...
        out1: for (int i = 0; i < 150; i++) {
            if (completedPositionsOfPlayer1[i][0] != -1) {
                g.drawLine(75 + completedPositionsOfPlayer1[i][0] * 50, 125 + completedPositionsOfPlayer1[i][1] * 50,
                        75 + completedPositionsOfPlayer1[i][2] * 50, 125 + completedPositionsOfPlayer1[i][3] * 50);
            } else {
                break out1;
            }
        }
        ...
        out2: for (int i = 0; i < 150; i++) {
            if (completedPositionsOfPlayer2[i][0] != -1) {
                g.drawLine(75 + completedPositionsOfPlayer2[i][0] * 50, 125 + completedPositionsOfPlayer2[i][1] * 50,
                        75 + completedPositionsOfPlayer2[i][2] * 50, 125 + completedPositionsOfPlayer2[i][3] * 50);
            } else {
                break out2;
            }
        }
