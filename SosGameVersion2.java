...
public class SosGameVersion2 extends Frame implements MouseListener {
    gameBoard board;
    Button closeButton;
    Button playAgain;
    Button sButton;
    ...
    boolean checkPoint(int n, int n2) {
        ...
        if (this.board.board[n][n2] == 'O') {
            ...
            if (n == 0 || n == 9) {
                if (n2 >= 1 && n2 <= 8 && this.board.board[n][n2 - 1] == 'S' && this.board.board[n][n2 + 1] == 'S') {
                    if (this.playerMove % 2 == 1) {
                        this.board.completedPlayer1[this.playerOneScore][0] = n;
                        this.board.completedPlayer1[this.playerOneScore][1] = n2 - 1;
                        this.board.completedPlayer1[this.playerOneScore][2] = n;
                        this.board.completedPlayer1[this.playerOneScore][3] = n2 + 1;
                        ++this.playerOneScore;
                    } else {
                        this.board.completedPlayer2[this.playerTwoScore][0] = n;
                        this.board.completedPlayer2[this.playerTwoScore][1] = n2 - 1;
                        this.board.completedPlayer2[this.playerTwoScore][2] = n;
                        this.board.completedPlayer2[this.playerTwoScore][3] = n2 + 1;
                        ++this.playerTwoScore;
                    }
                    bl = true;
                }
                ...
                if (this.board.board[n - 1][n2] == 'S' && this.board.board[n + 1][n2] == 'S') {
                    if (this.playerMove % 2 == 1) {
                        this.board.completedPlayer1[this.playerOneScore][0] = n - 1;
                        this.board.completedPlayer1[this.playerOneScore][1] = n2;
                        this.board.completedPlayer1[this.playerOneScore][2] = n + 1;
                        this.board.completedPlayer1[this.playerOneScore][3] = n2;
                        ++this.playerOneScore;
                    } else {
                        this.board.completedPlayer2[this.playerTwoScore][0] = n - 1;
                        this.board.completedPlayer2[this.playerTwoScore][1] = n2;
                        this.board.completedPlayer2[this.playerTwoScore][2] = n + 1;
                        this.board.completedPlayer2[this.playerTwoScore][3] = n2;
                        ++this.playerTwoScore;
                    }
                    bl = true;
                }
            ...
            if (n <= 7 && this.board.board[n + 2][n2] == 'S' && this.board.board[n + 1][n2] == 'O') {
                if (this.playerMove % 2 == 1) {
                    this.board.completedPlayer1[this.playerOneScore][0] = n + 2;
                    this.board.completedPlayer1[this.playerOneScore][1] = n2;
                    this.board.completedPlayer1[this.playerOneScore][2] = n;
                    this.board.completedPlayer1[this.playerOneScore][3] = n2;
                    ++this.playerOneScore;
                } else {
                    this.board.completedPlayer2[this.playerTwoScore][0] = n + 2;
                    this.board.completedPlayer2[this.playerTwoScore][1] = n2;
                    this.board.completedPlayer2[this.playerTwoScore][2] = n;
                    this.board.completedPlayer2[this.playerTwoScore][3] = n2;
                    ++this.playerTwoScore;
            ...
            if (n2 <= 7 && this.board.board[n][n2 + 2] == 'S' && this.board.board[n][n2 + 1] == 'O') {
                if (this.playerMove % 2 == 1) {
                    this.board.completedPlayer1[this.playerOneScore][0] = n;
                    this.board.completedPlayer1[this.playerOneScore][1] = n2 + 2;
                    this.board.completedPlayer1[this.playerOneScore][2] = n;
                    this.board.completedPlayer1[this.playerOneScore][3] = n2;
                    ++this.playerOneScore;
                } else {
                    this.board.completedPlayer2[this.playerTwoScore][0] = n;
                    this.board.completedPlayer2[this.playerTwoScore][1] = n2 + 2;
                    this.board.completedPlayer2[this.playerTwoScore][2] = n;
                    this.board.completedPlayer2[this.playerTwoScore][3] = n2;
                    ++this.playerTwoScore;
                }
