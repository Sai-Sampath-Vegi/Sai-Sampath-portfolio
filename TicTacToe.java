...
public class TicTacToe extends Frame implements ActionListener {
	...
	boolean checkWin() {
		if (btns[0].getLabel() == btns[1].getLabel() && btns[1].getLabel() == btns[2].getLabel()
				&& (!(btns[0].getLabel().equals("")))) {
			btns[0].setBackground(Color.GREEN);
			btns[1].setBackground(Color.GREEN);
			btns[2].setBackground(Color.GREEN);
			showState(1);
			return true;
		} else if (btns[3].getLabel() == btns[4].getLabel() && btns[4].getLabel() == btns[5].getLabel()
				&& (!(btns[3].getLabel().equals("")))) {
			btns[3].setBackground(Color.GREEN);
			btns[4].setBackground(Color.GREEN);
			btns[5].setBackground(Color.GREEN);
			showState(1);
			return true;
		} else if (btns[6].getLabel() == btns[7].getLabel() && btns[7].getLabel() == btns[8].getLabel()
				&& (!(btns[6].getLabel().equals("")))) {
			btns[6].setBackground(Color.GREEN);
			btns[7].setBackground(Color.GREEN);
			btns[8].setBackground(Color.GREEN);
			showState(1);
			return true;
		} else if (btns[0].getLabel() == btns[3].getLabel() && btns[3].getLabel() == btns[6].getLabel()
				&& (!(btns[0].getLabel().equals("")))) {
			btns[0].setBackground(Color.GREEN);
			btns[3].setBackground(Color.GREEN);
			btns[6].setBackground(Color.GREEN);
			showState(1);
			return true;
		} else if (btns[1].getLabel() == btns[4].getLabel() && btns[4].getLabel() == btns[7].getLabel()
				&& (!(btns[1].getLabel().equals("")))) {
			btns[1].setBackground(Color.GREEN);
			btns[4].setBackground(Color.GREEN);
			btns[7].setBackground(Color.GREEN);
			showState(1);
			return true;
		} else if (btns[2].getLabel() == btns[5].getLabel() && btns[5].getLabel() == btns[8].getLabel()
				&& (!(btns[2].getLabel().equals("")))) {
			btns[2].setBackground(Color.GREEN);
			btns[5].setBackground(Color.GREEN);
			btns[8].setBackground(Color.GREEN);
			showState(1);
			return true;
		} else if (btns[0].getLabel() == btns[4].getLabel() && btns[4].getLabel() == btns[8].getLabel()
				&& (!(btns[0].getLabel().equals("")))) {
			btns[0].setBackground(Color.GREEN);
			btns[4].setBackground(Color.GREEN);
			btns[8].setBackground(Color.GREEN);
			showState(1);
			return true;
		} else if (btns[2].getLabel() == btns[4].getLabel() && btns[4].getLabel() == btns[6].getLabel()
				&& (!(btns[2].getLabel().equals("")))) {
			btns[2].setBackground(Color.GREEN);
			btns[4].setBackground(Color.GREEN);
			btns[6].setBackground(Color.GREEN);
